(defproject pomodonut "0.1.0-SNAPSHOT"
              ...
              {:app
               {:source-paths ["src/cljs"]
                ...
                :compiler {:main pomodonut.core
                           ...
                           :output-to "resources/public/js/compiled/pomodonut.js"
  ...
  :aliases {"migrate" ["run" "-m" "pomodonut.migrations/migrate"]
            "rollback" ["run" "-m" "pomodonut.migrations/rollback"]}
  :doo {:build "test"}
